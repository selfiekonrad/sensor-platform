...
public class AuthentificationService {
    ...
    public AuthentificationService(EncryptionService encryptionService, SensorRepository sensorRepository) {
        this.encryptionService = encryptionService;
        this.sensorRepository = sensorRepository;
    }

    public void authenticateSensor(UUID sensorId, String apiKey) throws SensorUnauthorizedException {
        if (StringUtils.isEmpty(sensorId.toString())) {
            log.info("Provided Sensor ID was blank");
